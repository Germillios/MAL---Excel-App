IF NOT EXISTS (
    select * from sysobjects where name='anime_ilosc_ver2' and xtype='U'
) CREATE TABLE anime_ilosc_ver2 (
	...
	--CONSTRAINT FK_AnimeFromMAL FOREIGN KEY (AnimeID)
	--REFERENCES animelist_1538511199_3585579(ID)
--);
INSERT INTO anime_ilosc_ver2 VALUES
...
SELECT * FROM anime_ilosc_ver2;
SELECT * FROM dbo.anime_ilosc_ver2 ORDER BY Title ASC;
DELETE FROM dbo.anime_ilosc_ver2 WHERE ID >= 575;

ALTER TABLE anime_ilosc_ver2
ADD FOREIGN KEY (AnimeID) REFERENCES animelist_1538511199_3585579(myanimelist_anime_series_title);